...
import com.itsyx.im.codec.pack.group.GroupMemberSpeakPack;
...
import com.itsyx.im.service.group.dao.ImGroupMemberEntity;
import com.itsyx.im.service.group.dao.mapper.ImGroupMemberMapper;
import com.itsyx.im.service.group.model.callback.AddMemberAfterCallback;
...
public class ImGroupMemberServiceImpl implements ImGroupMemberService {
    ...
    public ResponseVO importGroupMember(ImportGroupMemberReq req) {
        ...
        for (GroupMemberDto memberId : req.getMembers()) {
            ...
            try {
                responseVO = this.addGroupMember(req.getGroupId(), req.getAppId(), memberId);
            } catch (Exception e) {
                e.printStackTrace();
